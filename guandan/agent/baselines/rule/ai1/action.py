    ...
    def Single(self, actionList, curAction, rank_card, handcards, numofplayers, rest_cards, card_val, myPos, greaterPos,
        ...
        if numofnext <= 4 or (numofpre <= 3 and numofpre >= 1):
            ...
            for action in single_actionList:
                Index = action[0]
                action = action[1]
                if card_val[action[1]] >= max_val - 2 and action[2][0] not in bomb_member and rank_card not in action[
                    2]:
                    if is_inStraight(action, straight_member):
                        continue
                    return Index
    ...
    def ThreeWithTwo(self, actionList, curAction, rank_card, handcards, numofplayers,
        ...
        if numofnext <= 7 or (numofpre <= 7 and numofpre >= 1):
            ...
            for action in three2_sorted:
                ...
                trip = action[2][0]
                pair = action[2][3]
                if trip in trip_member and pair in pair_member and rank_card not in action[2] and card_val[
                    pair[1]] <= 13:
                    return index
            ...
            for action in three2_sorted:
                ...
                trip = action[2][0]
                pair = action[2][3]
                if trip in trip_member and pair in trip_member and rank_card not in action[2] and card_val[
                    pair[1]] >= 10:
                    return index
